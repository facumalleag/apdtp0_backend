-- Microsofr SQL Server dump 10.13  Distrib 5.7.17, for macos10.12 (x86_64)
--
-- Host: 127.0.0.1    Database: TPO_AD_v1_0
-- ------------------------------------------------------
-- Server version	5.7.18
-- averiguar los datos de arriba (Server version, dump, Distrib, etc)
